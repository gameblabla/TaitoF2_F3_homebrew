//*****************************************************************
//* PCX to F3 sprite converter. (Paletted)
//*****************************************************************
...
{
    printf("PCX to F3 sprite converter.\n");
    ...
    memset(Bank1, 0x00, BANKSIZE);
    memset(Bank2, 0x00, BANKSIZE);
...
void Usage()
{
    printf("Command syntax is: PcxToF3Sprite Offset Infile.pcx Rom1 Rom2 [Palette] [Palettes]\n");
